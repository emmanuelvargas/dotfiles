...
<p align="center">
  <a href="https://github.com/emmanuelvargas/dotfiles" title="Automate all the things!">
    <img width="140" src="https://github.com/emmanuelvargas/dotfiles/raw/main/.github/logo.png" />
  </a>
</p>
...
This project is a fork and adapt for my need of the [Lissy93 project](https://github.com/Lissy93/dotfiles)
- Adding ability to manage some secret from a private bitwarden selfhosted server :
`BW_CLIENTID`
`BW_CLIENTSECRET`
`BW_PASSWORD`
`BW_SERVER`
  - privates aliases
  - privates env (work and perso)
  - privates zsh / bashrc functions
- adding firefox and floorp user.js preferences
- removing MACOS support (don't have one to test)
...
I went with an Alpine-based Docker container defined in the [`Dockerfile`](https://github.com/Lissy93/dotfiles/blob/main/Dockerfile). To try it out, just run `docker run lissy93/dotfiles`.
...
```bash
bash <(curl -s https://raw.githubusercontent.com/emmanuelvargas/dotfiles/main/lets-go.sh)
```

This will execute the quick setup script (in [`lets-go.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/lets-go.sh)), which just clones the repo (if not yet present), then executes the [`install.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/install.sh) script. You can re-run this at anytime to update the dotfiles. You can also optionally pass in some variables to change the install location (`DOTFILES_DIR`) and source repo (`DOTFILES_REPO`) and some variable for Bitwarden (`BW_CLIENTID`, `BW_CLIENTSECRET`, `BW_PASSWORD`, `BW_SERVER`) to use your fork.
...
_Alternatively, you can clone the repo yourself, cd into it, allow execution of [`install.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/install.sh) then run it to install or update._
...
```bash
git clone --recursive git@github.com:emmanuelvargas/dotfiles.git ~/.dotfiles
...
~
└──.
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/config">config/</a>               # All configuration files
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/bash">bash/</a>               # Bash (shell) config
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/tmux">tmux/</a>               # Tmux (multiplexer) config
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/vim">vim/</a>                # Vim (text editor) config
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/zsh">zsh/</a>                # ZSH (shell) config
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/macos">macos/</a>              # Config files for Mac-specific apps
   │ └── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/desktop-apps">desktop-apps/</a>       # Config files for GUI apps
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/scripts">scripts/</a>              # Bash scripts for automating tasks
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/scripts/installs">installs/</a>           # Scripts for software installation
   │ │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/Brewfile">Brewfile</a>          # Package installs for MacOS via Homebrew
   │ │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/arch-pacman.sh">arch-pacman.sh</a>    # Package installs for Arch via Pacman
   │ │ └── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/flatpak.sh">flatpak.sh</a>        # Package installs for Linux desktops via Flatpak
   │ ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/scripts/linux">linux/</a>              # Automated configuration for Linux
   │ │ └── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/linux/dconf-prefs.sh">dconf-prefs.sh</a>    # Setting GNOME settings via dconf util
   │ └── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/scripts/macos-setup">macos-setup/</a>        # Scripts for setting up Mac OS machines
   │   ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/macos-setup/macos-apps.sh">macos-apps.sh</a>     # Sets app preferences
   │   ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/macos-setup/macos-preferences.sh">macos-prefs.sh</a>    # Sets MacOS system preferences
   │   └── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/macos-setup/macos-security.sh">macos-security.sh</a> # Applies MacOS security and privacy settings
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/utils">utils/</a>                # Handy Shell utilitis for various day-to-day tasks
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/.github">.github/</a>              # Meta files for GitHub repo
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/tree/main/lib">lib/</a>                  # External dependencies, as git sub-modules
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/lets-go.sh">lets-go.sh</a>            # One-line remote installation entry point
   ├── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/install.sh">install.sh</a>            # All-in-one install and setup script
   └── <a href="https://github.com/emmanuelvargas/dotfiles/blob/main/symlinks.yaml">symlinks.yml</a>          # List of symlink locations
</pre>
...
The setup script ([`install.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/install.sh)) will do the following:
...
- **Setup**
  ...
  - Set variables by reading any passed parameters, or fallback to sensible defaults (see [`.zshenv`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/.zshenv))  
- **Dotfiles**
...
- **Env Vars**
  - `REPO_NAME` - The repository name to pull, e.g. `emmanuelvargas/Dotfiles`
...
The locations for all symlinks are defined in [`symlinks.yaml`](https://github.com/emmanuelvargas/dotfiles/blob/main/symlinks.yaml). These are managed using [Dotbot](https://github.com/anishathalye/dotbot), and will be applied whenever you run the [`install.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/install.sh) script. The symlinks set locations based on XDG paths, all of which are defined in [`.zshenv`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/.zshenv).
...
All aliases in my dotfiles are categorised into files located in [`zsh/aliases/`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/) which are imported in [`zsh/.zshrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/.zshrc#L9-L14).
...
> [`zsh/aliases/git.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/git.zsh)
...
> [`zsh/aliases/flutter.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/flutter.zsh)
...
> [`zsh/aliases/rust.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/rust.zsh) <br>
...
> [`zsh/aliases/node-js.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/node-js.zsh)
...
> [`zsh/aliases/general.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/general.zsh)
...
Package lists are stored in [`scripts/installs/`](https://github.com/emmanuelvargas/dotfiles/tree/main/scripts/installs) directory, with separate files for different OSs. The install script will [pick the appropriate file](https://github.com/emmanuelvargas/dotfiles/blob/22c6a04fdb22c140448b7d15ef8187c3a424ab47/install.sh#L243-L260) based on your distro.
...
- Linux (desktop): [`flatpak.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/flatpak.sh) - Desktop apps can be installed on Linux systems via [Flatpack](https://flatpak.org/)
- Mac OS: [`Brewfile`](https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/Brewfile) - Mac apps installed via [Homebrew](https://brew.sh/)
- Arch (and Arch-based systems, like Manjaro): [`arch-pacman.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/arch-pacman.sh) - Arch CLI apps installed via [pacman](https://wiki.archlinux.org/title/Pacman)
- Debian (and Debian-based systems, like Ubuntu): [`debian-apt.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/debian-apt.sh) - Debian CLI apps installed via [apt](https://wiki.debian.org/Apt)
- Alpine: [`aplpine-apk.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/scripts/installs/aplpine-apk.sh) - Alpine CLI apps installed via [apk](https://docs.alpinelinux.org/user-handbook/0.1a/Working/apk.html)
...
All config files are located in [`./config/`](https://github.com/emmanuelvargas/dotfiles/tree/main/config/).

Configurations for ZSH, Tmux, Vim, and a few others are in dedicated sub-directories (covered in the section below). While all other, small config files are located in the [`./config/general`](https://github.com/emmanuelvargas/dotfiles/tree/main/config/general) direcroty, and include:

- [`.bashrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.bashrc)
- [`.curlrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.curlrc)
- [`.gemrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.gemrc)
- [`.gitconfig`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.gitconfig)
- [`.gitignore_global`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.gitignore_global)
- [`.wgetrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/.wgetrc)
- [`dnscrypt-proxy.toml`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/dnscrypt-proxy.toml)
- [`gpg.conf`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/gpg.conf)
- [`starship.toml`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/general/starship.toml)
...
My ZSH config is located in [`config/zsh/`](https://github.com/emmanuelvargas/dotfiles/tree/main/config/zsh)

---

### Vim

The entry point for the Vim config is the [`vimrc`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/vim/vimrc), but the main editor settings are defined in [`vim/editor.vim`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/vim/editor.vim)

#### Vim Plugins

Vim plugins are managed using [Plug](https://github.com/junegunn/vim-plug) defined in [`vim/plugins.vim`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/vim/setup-vim-plug.vim).
To install them from GitHub, run `:PlugInstall` (see [options](https://github.com/junegunn/vim-plug#commands)) from within Vim. They will also be installed or updated when you run the main dotfiles setup script ([`install.sh`](https://github.com/emmanuelvargas/dotfiles/blob/d4b8426629e7fbbd6d17d0b87f0bb863d6618bfd/install.sh#L132-L134)).
...
Fairly standard Tmux configuration, strongly based off Tmux-sensible. Configuration is defined in [`.tmux.conf`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/tmux/tmux.conf)

Tmux plugins are managed using [TMP](https://github.com/tmux-plugins/tpm) and defined in [`.tmux.conf`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/tmux/tmux.conf). To install them from GitHub, run `prefix` + <kbd>I</kbd> from within Tmux, and they will be cloned int `~/.tmux/plugins/`.
...
Git aliases for ZSH are located in [`/zsh/aliases/git.zsh`](https://github.com/emmanuelvargas/dotfiles/blob/main/config/zsh/aliases/git.zsh), and are documented under the [Aliases](https://github.com/lissy93/dotfiles#my-aliases) section, above.
...
> Source: [`utils/transfer.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/utils/transfer.sh)
...
> Source: [`utils/web-search.sh`](https://github.com/emmanuelvargas/dotfiles/blob/main/utils/web-search.sh)
...
```bash
bash <(curl -s https://raw.githubusercontent.com/emmanuelvargas/dotfiles/main/utils/web-search.sh)
```
